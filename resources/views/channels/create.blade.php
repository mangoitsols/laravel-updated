...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Add Channel'])
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file" id="logo" name="logo"
                                                accept="image/*">
                                            <span class="invalid-feedback text-sm text-danger"></span>
                                            <p class="form-text text-muted comment">Recommended format - png, no smaller
                                                than
                                                96*96
                                                pixels,
                                                maximum
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min='0' class="form-control" id="epg_offset"
                                                name="epg_offset" value="{{ old('epg_offset') }}">
                                            <span class="invalid-feedback text-sm text-danger"></span>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="censored"
                                                    value="1" name="censored"
                                                    {{ old('censored') ? 'checked' : '' }}>
